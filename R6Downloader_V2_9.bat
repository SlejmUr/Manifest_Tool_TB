...
goto 7zipcheck
  ...
  start https://download.visualstudio.microsoft.com/download/pr/73718445-e2bd-40b7-b698-e8a9ac65f4e5/0816570f697c4e8f1b53ecfb33eaed7f/dotnet-sdk-3.1.300-win-x64.exe
  cls
...
:PlazaCheck
  ...
  :GetPlaza
    ...
    echo ------------------------------------------------------------------------------
    curl -L  "https://slejmur.keybase.pub/basic-cracks.zip?dl=1" --output plazas.zip
    ::Extract
    for %%I in ("plazas.zip") do (
    "Resources\7z.exe" x -y -o"Resources\" "%%I" -aoa && del %%I
    )
    cd Resources
    ren basic-cracks Plazas
    cd ..
    goto PlazaCheck
...
pause
echo [1m[93m
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 8733653062998518164 -username %username% -remember-password -dir "Downloads\Y6S2_NorthStar"  -validate -max-servers 15 -max-downloads 10
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 809542866761090243 -username %username% -remember-password -dir "Downloads\Y6S2_NorthStar" -validate -max-servers 15 -max-downloads 10 [0m
pause
Robocopy Resources\Plazas\CPlay Downloads\Y6S2_NorthStar /s
goto downloadcomplete
...
:northstar
MODE 120,20
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377238 -manifest 8733653062998518164 -username %username% -remember-password -dir "Downloads\Y6S2_NorthStar" -validate -max-servers 15 -max-downloads 10 [0m
pause
goto downloadcomplete
...
echo                        Any CPlay / Lumaplay error/fail , please contact SlejmUr or other helpers!
echo.
Resources\cmdMenuSel f870 "  <- Back to Guide and FAQ"
if %ERRORLEVEL% == 1 goto guidefaq