...
::Zh4grVQjdCiDJGvS2W0UFykCYyimAFnsK5o41Mf369jRkXEvUe46eZze5raPNLIW8kDYV5c56U5Vp+4UCSR7cRy9ax0grHx+hmuXI8aevwrdTEGH50cMKTNQiHTegCQ6ZNZ6pfVQ7HHw+VX6/w==
::YB416Ek+ZG8=
::
::
...
::Credit to SlejmUr for the .NET checker
:dotnetcheck
...
::Get shits
  ...
  :DepotDownloader
    ...
    echo -------------------------------------------------------------------------------
    curl -L  "https://github.com/SteamRE/DepotDownloader/releases/download/DepotDownloader_2.5.0/depotdownloader-2.5.0.zip" --ssl-no-revoke --output depot.zip
    ::Extract
...
pause
echo [1m[93m
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 4466027729495813039 -username %username% -remember-password -dir "Downloads\Y7S4_SnowBrawl"  -validate -max-servers 15 -max-downloads 10
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 1819898955518120444 -username %username% -remember-password -dir "Downloads\Y7S4_SnowBrawl" -validate -max-servers 15 -max-downloads 10 [0m
pause
...
pause
echo [1m[93m
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 3050554908913191669 -username %username% -remember-password -dir "Downloads\ToyRainbow3"  -validate -max-servers 15 -max-downloads 10
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 1575870740329742681 -username %username% -remember-password -dir "Downloads\ToyRainbow3" -validate -max-servers 15 -max-downloads 10 [0m
pause
Robocopy Resources\Plazas\Y8SX Downloads\ToyRainbow3 /s
goto downloadcomplete
...
:ruscommandingforce
MODE 120,20
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377238 -manifest 4293396692730784956 -username %username% -remember-password -dir "Downloads\ToyRainbow3" -validate -max-servers 15 -max-downloads 10 [0m
pause
goto downloadcomplete
