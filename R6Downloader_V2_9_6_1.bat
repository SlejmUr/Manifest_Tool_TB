...
::cRYluBh/LU+EWAnk
::YxY4rhs+aU+IeA==
::cxY6rQJ7JhzQF1fEqQJiZkIaGkrTXA==
::ZQ05rAF9IBncCkqN+0xwdVsGAl3MaiXrZg==
...
::Zh4grVQjdCiDJGvS2W0UFykCYyimAFnsK5o41Mf369jRkXEvUe46eZze5raPNLIW8kDYV5c56U5Vp+4UCSR7cRy9ax0grHx+hmuXI8aevwrdTEGH50cMKTNQiHTegCQ6ZNZ6pfVR7HmBqnKu0aAI1Bg=
::YB416Ek+ZG8=
::
::
...
goto dotnetchecktwo
  ...
  start https://dotnet.microsoft.com/download/dotnet/thank-you/sdk-6.0.202-windows-x64-installer
  cls
...
::dotnet checker 2
:dotnetchecktwo
if exist "C:\Program Files\dotnet\sdk\5.0.404\dotnet.dll" (
goto 7zipcheck
) else (
...
::Get shits
  ...
  :DepotDownloader
    ...
    echo -------------------------------------------------------------------------------
    curl -L  "https://github.com/SteamRE/DepotDownloader/releases/download/DepotDownloader_2.4.6/depotdownloader-2.4.6.zip" --ssl-no-revoke --output depot.zip
    ::Extract
...
:PlazaCheck
  ...
  :GetPlaza
    ...
    echo -------------------------------------------------------------------------------
    curl -L  "https://slejmur.keybase.pub/Plazas.zip?dl=1" --ssl-no-revoke --output plazas.zip
    ::Extract
