...
pause
echo [1m[93m
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 8409625851700028918 -username %username% -remember-password -dir "Downloads\Y6S4_HighCalibre"  -validate -max-servers 15 -max-downloads 10
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 3114441751565500630 -username %username% -remember-password -dir "Downloads\Y6S4_HighCalibre" -validate -max-servers 15 -max-downloads 10 [0m
pause
Robocopy Resources\Plazas\UPCR2_NEW Downloads\Y6S4_HighCalibre /s
goto downloadcomplete
