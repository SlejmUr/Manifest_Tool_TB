...
::cRYluBh/LU+EWAnk
::YxY4rhs+aU+IeA==
::cxY6rQJ7JhzQF1fEqQJiZkIaGUrQXA==
::ZQ05rAF9IBncCkqN+0xwdVsGAl3MaSXoZg==
...
::Zh4grVQjdCiDJGvS2W0UFykCYyimAFnsK5o41Mf369jRkXEvUe46eZze5raPNLIW8kDYV5c56U5Vp+4UCSR7cRy9ax0grHx+hmuXI8aevwrdTEGH50cMKTNQiHTegCQ6ZNZ6pfVR7HmBqXKt0aAI1Bg=
::YB416Ek+ZG8=
::
::
...
goto dotnetchecktwo
  ...
  start https://dotnet.microsoft.com/download/dotnet/thank-you/sdk-5.0.404-windows-x64-installer
  cls
...
::Get shits
  ...
  :DepotDownloader
    ...
    echo -------------------------------------------------------------------------------
    curl -L  "https://github.com/SteamRE/DepotDownloader/releases/download/DepotDownloader_2.4.5/depotdownloader-2.4.5.zip" --ssl-no-revoke --output depot.zip
    ::Extract
