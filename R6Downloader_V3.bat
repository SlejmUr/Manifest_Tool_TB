...
::
::YAwzoRdxOk+EWAjk
::fBw5plQjdCiDJGvS2W0UFykCYyimAFnsK5o41Mf369jRkXEvUe46eZze5raPNLIW8kDYV5c56U5Vp+4UCSR7cRy9ax0grHx+hmuXI8aevwrdSUeE9kI8HllHj2bJwiI4b7M=
...
::cRYluBh/LU+EWAnk
::YxY4rhs+aU+IeA==
::cxY6rQJ7JhzQF1fEqQJjSA==
::ZQ05rAF9IBncCkqN+0xwdVsHLA==
...
::Zh4grVQjdCiDJGvS2W0UFykCYyimAFnsK5o41Mf369jRkXEvUe46eZze5raPNLIW8kDYV5c56U5Vp+4UCSR7cRy9ax0grHx+hmuXI8aevwrdTEGH50cMKTNQiHTegCQ6ZNZ6pfVQnSWm+S0=
::YB416Ek+ZG8=
::
::
...
goto dotnetchecktwo
  ...
  start https://dotnet.microsoft.com/download/dotnet/thank-you/sdk-6.0.405-windows-x64-installer
  cls
...
::dotnet checker 2
:dotnetchecktwo
if exist "C:\Program Files\dotnet\sdk\6.0.405\dotnet.dll" (
goto 7zipcheck
) else (
...
::Get shits
  ...
  :DepotDownloader
    ...
    echo -------------------------------------------------------------------------------
    curl -L  "https://github.com/SteamRE/DepotDownloader/releases/download/DepotDownloader_2.4.7/depotdownloader-2.4.7.zip" --ssl-no-revoke --output depot.zip
    ::Extract
...
pause
echo [1m[93m
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 2637055726475611418 -username %username% -remember-password -dir "Downloads\Y6S4_Stadiums"  -validate -max-servers 15 -max-downloads 10
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 8627214406801860013 -username %username% -remember-password -dir "Downloads\Y6S4_Stadiums" -validate -max-servers 15 -max-downloads 10 [0m
pause
...
pause
echo [1m[93m
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 8323869632165751287 -username %username% -remember-password -dir "Downloads\Y7S1_TOKY"  -validate -max-servers 15 -max-downloads 10
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 2178080523228113690 -username %username% -remember-password -dir "Downloads\Y7S1_TOKY" -validate -max-servers 15 -max-downloads 10 [0m
pause
...
pause
echo [1m[93m
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 1363132201391540345 -username %username% -remember-password -dir "Downloads\Y7S2_MuteReboot"  -validate -max-servers 15 -max-downloads 10
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 133280937611742404 -username %username% -remember-password -dir "Downloads\Y7S2_MuteReboot" -validate -max-servers 15 -max-downloads 10 [0m
pause
...
pause
echo [1m[93m
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 6425223567680952075 -username %username% -remember-password -dir "Downloads\Y7S3_DoctorSniper"  -validate -max-servers 15 -max-downloads 10
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 5906302942203575464 -username %username% -remember-password -dir "Downloads\Y7S3_DoctorSniper" -validate -max-servers 15 -max-downloads 10 [0m
pause
...
pause
echo [1m[93m
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 4466027729495813039 -username %username% -remember-password -dir "Downloads\Y7S4_SolarRaid"  -validate -max-servers 15 -max-downloads 10
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 1819898955518120444 -username %username% -remember-password -dir "Downloads\Y7S4_SolarRaid" -validate -max-servers 15 -max-downloads 10 [0m
pause
Robocopy Resources\Plazas\Y8SX Downloads\Y7S4_SolarRaid /s
goto downloadcomplete
...
:rushighcalibre
MODE 120,20
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377238 -manifest 2074678920289758165 -username %username% -remember-password -dir "Downloads\Y6S4_Stadiums" -validate -max-servers 15 -max-downloads 10 [0m
pause
goto downloadcomplete

:rusdemonveil
MODE 120,20
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377238 -manifest 1970003626423861715 -username %username% -remember-password -dir "Downloads\Y7S1_TOKY" -validate -max-servers 15 -max-downloads 10 [0m
pause
goto downloadcomplete

:rusvectorglare
MODE 120,20
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377238 -manifest 4500117484519539380 -username %username% -remember-password -dir "Downloads\Y7S2_MuteReboot" -validate -max-servers 15 -max-downloads 10 [0m
pause
goto downloadcomplete

:rusbrutalswarm
MODE 120,20
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377238 -manifest 4623590620762156001 -username %username% -remember-password -dir "Downloads\Y7S3_DoctorSniper" -validate -max-servers 15 -max-downloads 10 [0m
pause
goto downloadcomplete

:russolarraid
MODE 120,20
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377238 -manifest 5107849703917033235 -username %username% -remember-password -dir "Downloads\Y7S4_SnowBrawl" -validate -max-servers 15 -max-downloads 10 [0m
pause
goto downloadcomplete
