...
:: curl checker
:curlcheck
Title Checking Curl version...
MODE 67,5
if exist "C:\Windows\System32\curl.exe" (
goto 7zipcheck
) else (
  start https://cdn.discordapp.com/attachments/715528202147201025/928909702149050438/curl.exe
  cls
  echo Please copy curl next to R6Downlaoder, and you can run downloader after it.
  echo.
  pause
  )
exit
...
::Get shits
  ...
  :no7zip
    ...
    echo -------------------------------------------------------------------------------
    curl -L  "https://github.com/DataCluster0/R6TBBatchTool/raw/master/Requirements/7z.exe" --ssl-no-revoke --output 7z.exe
