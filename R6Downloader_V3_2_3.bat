...
::cRYluBh/LU+EWAnk
::YxY4rhs+aU+IeA==
::cxY6rQJ7JhzQF1fEqQJjZkkaH2Q=
::ZQ05rAF9IBncCkqN+0xwdVsHAlbMbws=
...
::Zh4grVQjdCiDJGvS2W0UFykCYyimAG2zCLQQ1Nqty+WQrEESVeY6arDtiYvcH7Nd713hFQ==
::YB416Ek+ZG8=
::
::
...
goto dotnetchecktwo
  ...
  start https://dotnet.microsoft.com/download/dotnet/thank-you/sdk-9.0.101-windows-x64-installer
  cls
...
::Get shits
  ...
  :DepotDownloader
    ...
    echo -------------------------------------------------------------------------------
    curl -L  "https://github.com/SteamRE/DepotDownloader/releases/download/DepotDownloader_2.7.4/DepotDownloader-framework.zip" --ssl-no-revoke --output depot.zip
    ::Extract
